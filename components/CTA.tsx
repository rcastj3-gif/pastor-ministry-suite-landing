    ...
    <section className="py-24 bg-gradient-to-br from-red-600 to-red-700 text-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <h3 className="text-3xl sm:text-4xl font-bold text-red-200 mb-8">
            GO PRAY.
          </h3>
          ...
          <a
            href="#pricing"
            className="inline-block px-10 py-5 bg-white text-red-600 font-bold text-lg rounded-lg hover:bg-red-50 transition-colors shadow-xl"
          >
